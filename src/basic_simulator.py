...
class BasicSimulator:
    ...
    def __init__(self, robot_radius, robot_fov_radius, static_map_topic, local_goal_pose_topic,
        ...
        self.simulation_fov_pointcloud = PointCloud()
    ...
    def _local_goal_pose_callback(self, local_pose_goal):
        ...
        is_colliding_with_static_obstacles = (
                ...
                not self.simulated_map.inflated_static_occ_grid[goal_map_coords[0]][goal_map_coords[1]] >= Utils.ROS_COST_POSSIBLY_CIRCUMSCRIBED)
...
if __name__ == "__main__":
    ...
    basic_simulator = BasicSimulator(0.05, 1.0,
    ...
    basic_simulator.manually_add_obstacle_from_map_coordinates({(10, 3), (10, 6), (11, 3), (11, 6)}, Movability.movable)
